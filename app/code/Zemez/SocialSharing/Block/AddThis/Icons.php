...
namespace Zemez\SocialSharing\Block\AddThis;

use Zemez\SocialSharing\Helper\Data as SocialSharingHelper;
...
class Icons extends Template
{
    ...
    {
        return sprintf('styles/%s.phtml', $this->_helper->getStyle());
    }
}
